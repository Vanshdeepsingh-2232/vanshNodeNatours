      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return _axios.default.post('http://127.0.0.1:8000/api/v1/users/login', {
            ...
            (0, _alerts.showAlert)('error', error.res.data.message);
          });
        case 2:
          res = _context.sent;
        case 3:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Ps1kj2LkADhGgv9ogZHTVujBNL2FtQgTuJsuiWyubna9y3gkTJNu3xP9Xk5EOYw2F8Mrd5EbGEjEqpPxBuM2BFh00Ek1E5noG');
...
function initializeMap() {
  ...
  locations.forEach(function (loc) {
    new maplibregl.Marker().setLngLat(loc.coordinates).setPopup(new maplibregl.Popup().setText(loc.description)) // Add description as a popup
    .addTo(map);
  });
  ...
  // Return to the initial marker and start rotating around it
  function returnToInitialMarker() {
    var initialMarker = markers[0]; // First marker in the array
    map.flyTo({
      center: initialMarker,
      zoom: 15.5,
      pitch: 45,
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var signups = exports.signups = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, passwordConfirm) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _axios.default.post('http://127.0.0.1:8000/api/v1/users/signup', {
            name: name,
            email: email,
            password: password,
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'SignedUP in Successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function signups(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //import { logout } from '../../controllers/authController
document.addEventListener('DOMContentLoaded', function () {
  console.log('Document is ready');
  (0, _mapbox.initializeMap)();
});
...
var SignedUpForm = document.querySelector('.form--SignUp');
//values
...
if (SignedUpForm) {
  SignedUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name').value;
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
    (0, _signup.signups)(name, email, password, passwordConfirm);
  });
}
